...
for i in range(0, 1000):
	available = [a for a in range(1,10000)]
	with open("100x100inputs/input" + str(i) +".txt", "w") as f:
		...
		for snake in range(0, num_snakes):
			...
			snake_tail = random.choice([available[k] for k in range(0, snake_mouth_index)])
